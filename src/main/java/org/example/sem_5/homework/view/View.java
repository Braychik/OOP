package org.example.sem_5.homework.view;

import org.example.sem_5.homework.data.Komplex;
import org.example.sem_5.homework.data.Rational;
import org.example.sem_5.homework.dataService.Calculate;
...
public class View {
    ...
    private void doingRational() {
        ...
        while (flag) {
            ...
            Rational rational1 = creatRational();
            while (flag2) {
                scanner.nextLine();
    ...
    private void doingKomplex() {
        ...
        while (flag) {
            ...
            switch (doing.charAt(0)) {
                ...
                case ('-') ->
                        System.out.printf("%s - %s = %s" + "\n", number1, number2, calculat.difference(number1, number2));
                case ('*') ->
    ...
    private Rational creatRational() {
        Scanner scanner = new Scanner(System.in);
        int tmp = 1;
        int tmp2 = 1;
        boolean flag = true;
